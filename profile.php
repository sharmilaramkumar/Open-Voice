...
$stmt = $conn->prepare("SELECT username, age, dob, roll_number, address, phone_number, department FROM users WHERE id = ?");
$stmt->bind_param("i", $user_id);
$stmt->execute();
$stmt->store_result();
$stmt->bind_result($username, $age, $dob, $roll_number, $address, $phone_number, $department);
...
<body>
    ...
    <div class="profile-details">
        ...
        <div class="detail-item">
            ...
            <span class="detail-value"><?php echo isset($_SESSION['user']['username']) ? $_SESSION['user']['username'] : 'N/A'; ?></span>
        </div>
        <div class="detail-item">
